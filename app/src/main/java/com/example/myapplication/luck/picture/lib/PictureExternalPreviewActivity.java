...
import com.example.myapplication.luck.picture.lib.broadcast.BroadcastAction;
import com.example.myapplication.luck.picture.lib.broadcast.BroadcastManager;
...
import com.example.myapplication.luck.picture.lib.listener.OnImageCompleteCallback;
import com.example.myapplication.luck.picture.lib.permissions.PermissionChecker;
import com.example.myapplication.luck.picture.lib.photoview.PhotoView;
...
import com.example.myapplication.luck.picture.lib.widget.PreviewViewPager;
import com.example.myapplication.luck.picture.lib.widget.longimage.ImageSource;
import com.example.myapplication.luck.picture.lib.widget.longimage.ImageViewState;
import com.example.myapplication.luck.picture.lib.widget.longimage.SubsamplingScaleImageView;
...
public class PictureExternalPreviewActivity extends PictureBaseActivity implements View.OnClickListener {
    ...
    public class SimpleFragmentAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            final String path;
            if (media.isCut()/* && !media.iscom.example.myapplicationpressed()*/) {
                // 裁剪过
